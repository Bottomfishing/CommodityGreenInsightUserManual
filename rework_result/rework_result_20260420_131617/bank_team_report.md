...
- R2：0.8695
- 方向预测准确率（排除平盘）：0.5106
- 对数收益 R2（相对零收益基准）：-0.0002
- 涨跌辅助头 ROC-AUC：0.5297

## 2. 主要驱动因子（示例 Top-10）
| feature                  |   spearman_corr_with_return |   rf_importance |
|:-------------------------|----------------------------:|----------------:|
| WTI_Futures              |                  -0.162297  |      0.0366294  |
| RSI_14                   |                  -0.160175  |      0.0244768  |
| WTI_Futures_Momentum_5d  |                  -0.102597  |      0.020993   |
| WTI_Futures_RollRet_5    |                  -0.102597  |      0.0188241  |
| MACD                     |                  -0.0895387 |      0.0214907  |
| WTI_Spot                 |                  -0.0816238 |      0.0244204  |
| OVX_Return               |                  -0.0747871 |      0.0270382  |
| WTI_Futures_Acceleration |                   0.0739671 |      0.0315712  |
| OVX_Change               |                  -0.068375  |      0.0247163  |
| WTI_Futures_RollRet_60   |                  -0.0576129 |      0.00815443 |
...
|-----------------------:|----------------------:|-----------------------:|-------------------:|-------------------:|
|                1.00843 |              0.119422 |              -0.194785 |           0.406061 |        0.000751919 |
