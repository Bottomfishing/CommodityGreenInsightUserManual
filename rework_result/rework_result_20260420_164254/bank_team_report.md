...
- 对数收益 R2（AR(1) 基准）：-0.0049
- 对数收益 R2（均值基准）：-0.0098
- 涨跌辅助头 ROC-AUC：0.5131

## 2. 主要驱动因子（示例 Top-10）
| feature                  |   spearman_corr_with_return |   rf_importance |
|:-------------------------|----------------------------:|----------------:|
| WTI_Futures              |                  -0.162297  |      0.0359001  |
| RSI_14                   |                  -0.160175  |      0.0299701  |
| WTI_Futures_RollRet_5    |                  -0.102597  |      0.0218957  |
| WTI_Futures_Momentum_5d  |                  -0.102597  |      0.0213123  |
| MACD                     |                  -0.0895387 |      0.0242813  |
| WTI_Spot                 |                  -0.0816238 |      0.027701   |
| OVX_Return               |                  -0.0747871 |      0.0278752  |
| WTI_Futures_Acceleration |                   0.0739671 |      0.0377506  |
| OVX_Change               |                  -0.068375  |      0.0285891  |
| WTI_Futures_RollRet_60   |                  -0.0576129 |      0.00921727 |
...
|-----------------------:|----------------------:|-----------------------:|-------------------:|-------------------:|
|               0.119422 |              0.119422 |              -0.243083 |           0.506061 |        0.000706143 |
