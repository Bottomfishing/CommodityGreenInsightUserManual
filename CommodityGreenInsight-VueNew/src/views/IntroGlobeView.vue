<template>
  <div class="intro4-page">
    ...
    <main class="intro4-main">
      <section class="hero">
        <span class="kicker">GREEN FINTECH</span>
        <h1 class="hero-title">您可以洞察全球油价局势</h1>
        <p class="hero-sub">全球节点联动 · 区域供需脉冲 · 风险热区感知 · 关联路径洞察</p>
        <div class="action-row">
          <button class="btn-primary" @click="goLogin">继续</button>
          <button class="btn-ghost" @click="router.push({ name: 'IntroData' })">返回上一页</button>
        </div>
      </section>

      <section class="showcase">
        <article
          class="panel globe-panel-shell"
          :style="globeBoardStyle"
          @mousemove="onGlobeMove"
          @mouseleave="onGlobeLeave"
        >
...
const globeBoardStyle = ref<Record<string, string>>({});
...
function onGlobeMove(event: MouseEvent) {
